...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PhotonTeamsManager : MonoBehaviour, IMatchmakingCallbacks, IInRoomCallbacks
    {
        ...
        private Dictionary<byte, HashSet<Realtime.Player>> playersPerTeam;
        ...
        public static event Action<Realtime.Player, PhotonTeam> PlayerJoinedTeam;
        public static event Action<Realtime.Player, PhotonTeam> PlayerLeftTeam;
        ...
        private void Init()
        {
            ...
            playersPerTeam = new Dictionary<byte, HashSet<Realtime.Player>>(teamsList.Count);
            for (int i = 0; i < teamsList.Count; i++)
            {
                teamsByCode[teamsList[i].Code] = teamsList[i];
                teamsByName[teamsList[i].Name] = teamsList[i];
                playersPerTeam[teamsList[i].Code] = new HashSet<Realtime.Player>();
            }
        }
        ...
        void IInRoomCallbacks.OnPlayerPropertiesUpdate(Realtime.Player targetPlayer, Hashtable changedProps)
        {
            object temp;
        ...
        void IInRoomCallbacks.OnPlayerLeftRoom(Realtime.Player otherPlayer)
        {
        ...
        void IInRoomCallbacks.OnPlayerEnteredRoom(Realtime.Player newPlayer)
        {
        ...
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(byte code, out Realtime.Player[] members)
        {
            members = null;
            HashSet<Realtime.Player> players;
            if (this.playersPerTeam.TryGetValue(code, out players))
            {
                members = new Realtime.Player[players.Count];
                int i = 0;
        ...
        /// <param name="members">The array of players to be filled.</param>
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(string teamName, out Realtime.Player[] members)
        {
            members = null;
            PhotonTeam team;
        ...
        /// <param name="members">The array of players to be filled.</param>
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(PhotonTeam team, out Realtime.Player[] members)
        {
            members = null;
            if (team != null)
            {
        ...
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMatesOfPlayer(Realtime.Player player, out Realtime.Player[] teamMates)
        {
            teamMates = null;
            if (player == null)
            {
            ...
            if (this.playersPerTeam.TryGetValue(team.Code, out players))
            {
                ...
                teamMates = new Realtime.Player[players.Count - 1];
                int i = 0;
    ...
    public static class PhotonTeamExtensions
    {
        ...
        public static PhotonTeam GetPhotonTeam(this Realtime.Player player)
        {
            object teamId;
            PhotonTeam team;
        ...
        /// <returns></returns>
        public static bool JoinTeam(this Realtime.Player player, PhotonTeam team)
        {
            if (team == null)
            {
        ...
        /// <returns></returns>
        public static bool JoinTeam(this Realtime.Player player, byte teamCode)
        {
            PhotonTeam team;
        ...
        /// <returns></returns>
        public static bool JoinTeam(this Realtime.Player player, string teamName)
        {
            PhotonTeam team;
        ...
        public static bool SwitchTeam(this Realtime.Player player, PhotonTeam team)
        {
            if (team == null)
            {
        ...
        public static bool SwitchTeam(this Realtime.Player player, byte teamCode)
        {
            PhotonTeam team;
        ...
        /// <returns>If the team switch request is queued to be sent to the server or done in case offline or not joined to a room yet.</returns>
        public static bool SwitchTeam(this Realtime.Player player, string teamName)
        {
            PhotonTeam team;
        ...
        public static bool LeaveCurrentTeam(this Realtime.Player player)
        {
            PhotonTeam currentTeam = player.GetPhotonTeam();
            if (currentTeam == null)
            {
        ...
        /// <returns>If successful or not.</returns>
        public static bool TryGetTeamMates(this Realtime.Player player, out Realtime.Player[] teamMates)
        {

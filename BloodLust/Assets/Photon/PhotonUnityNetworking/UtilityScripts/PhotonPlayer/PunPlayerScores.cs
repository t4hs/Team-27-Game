...
namespace Photon.Pun.UtilityScripts
{
    ...
    {
        public static void SetScore(this Realtime.Player player, int newScore)
        {
        ...
        public static void AddScore(this Realtime.Player player, int scoreToAddToCurrent)
        {
        ...
        public static int GetScore(this Realtime.Player player)
        {
            object score;
